...
# echo
# echo "Link prediction results into KG..."
# python add_link_prediction.py \
#     --input_filepath=../../outputs/kgc/pykeen/annotations_predictions-above80_extdb_mesh_ncbi/hpo/RotatE/hypotheses_20230323_010058.tsv \
#     --input_kg_dir=../../outputs/kg/annotations_predictions_extdb_mesh_ncbi/ \
#     --output_kg_dir=../../outputs/kg/annotations_predictions_extdb_mesh_ncbi_lp \
#     --mode=predictions \
#     --nb_workers=10
...
python parse_final_kg.py \
    --input_kg_dir=../../outputs/kg/annotations_predictions_extdb_mesh_ncbi_lp \
